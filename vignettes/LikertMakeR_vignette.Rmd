...
####  same summated values with lower _alpha_ may require higher _variance_
...
#### makeRepeated() arguments
  ...
  -  _**items**_ Integer. Number of items used to generate each scale score (passed to `link{lfast}`).
...
Winzar, H. (2022). LikertMakeR: Synthesise and correlate Likert scale and 
